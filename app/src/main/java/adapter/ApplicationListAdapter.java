...
import com.app.zimfiz.zimfiz.FormOnePlace;
import com.app.zimfiz.zimfiz.HighSchoolPayment;
import com.app.zimfiz.zimfiz.LowerSixPlace;
import com.app.zimfiz.zimfiz.PrimarySchoolPayment;
import com.app.zimfiz.zimfiz.R;
import com.app.zimfiz.zimfiz.TransferStudent;
...
public class ApplicationListAdapter extends RecyclerView.Adapter<ApplicationListAdapter.SimpleViewHolder> {
    List<SimpleList> simplelist;
    Context context;

    public ApplicationListAdapter(Context context, List<SimpleList> simplelist) {
	...
	public SimpleViewHolder(View itemView) {
        ...
        public void onClick(View v) {
            ...
            case 0:
                ...
                context.startActivity(new Intent(context, FormOnePlace.class));
                break;
            case 1:

                context.startActivity(new Intent(context, LowerSixPlace.class));
                break;
            case 2:
                context.startActivity(new Intent(context, TransferStudent.class));
                break;
