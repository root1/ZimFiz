 ...
 */
public class PrimarySchool extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpleListList.add(new SimpleList("Grade 1"));
        simpleListList.add(new SimpleList("Grade 2"));
        simpleListList.add(new SimpleList("Grade 3"));
        simpleListList.add(new SimpleList("Grade 4"));
        simpleListList.add(new SimpleList("Grade 5"));
        simpleListList.add(new SimpleList("Grade 6"));
        simpleListList.add(new SimpleList("Grade 7"));
    ...
    public  boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id == R.id.notifications){
           startActivity(new Intent(PrimarySchool.this, AddNotification.class));
        }
        if(id == R.id.details){
            startActivity(new Intent(PrimarySchool.this, EditContact.class));
        }
    ...
    class UniversityListAdapter extends RecyclerView.Adapter<UniversityListAdapter.SimpleViewHolder> {
        ...
        public class SimpleViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                ...
                switch (getPosition()) {
                    case 0:
                        extras.putString("form", "Grade 1");
                        break;
                    case 1:
                        extras.putString("form", "Grade 2");
                        break;
                    case 2:
                        extras.putString("form", "Grade 3");
                        break;
                    case 3:
                        extras.putString("form", "Grade 4");
                        break;
                    case 4:
                        extras.putString("form", "Grade 5");
                        break;
                    case 5:
                        extras.putString("form", "Grade 6");
                        break;
                    case 6:
                        extras.putString("form", "Grade 7");
                        break;
