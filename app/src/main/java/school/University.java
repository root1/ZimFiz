...
public class University extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpleListList.add(new SimpleList("Part 1"));
        simpleListList.add(new SimpleList("Part 2"));
        simpleListList.add(new SimpleList("Part 3"));
        simpleListList.add(new SimpleList("Part 4"));
        simpleListList.add(new SimpleList("Part 5"));
        simpleListList.add(new SimpleList("Masters"));
        simpleListList.add(new SimpleList("Doctorate"));
    ...
    public  boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id == R.id.notifications){
           startActivity(new Intent(University.this, AddNotification.class));
        }
        if(id == R.id.details){
            startActivity(new Intent(University.this, EditContact.class));
        }
    ...
    class UniversityListAdapter extends RecyclerView.Adapter<UniversityListAdapter.SimpleViewHolder> {
        ...
        public class SimpleViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                ...
                switch (getPosition()) {
                    case 0:
                        extras.putString("form", "Part 1");
                        break;
                    case 1:
                        extras.putString("form", "Part 2");
                        break;
                    case 2:
                        extras.putString("form", "Part 3");
                        break;
                    case 3:
                        extras.putString("form", "Part 4");
                        break;
                    case 4:
                        extras.putString("form", "Part 5");
                        break;
                    case 5:
                        extras.putString("form", "Masters");
                        break;
                    case 6:
                        extras.putString("form", "Doctorate");
                        break;
